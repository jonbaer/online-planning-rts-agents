...
Solution::Solution (Solution *solution) {
 //cout << "Generating new solution inside Solution::Solution(solution *solution)" << endl;
  ...
  //cout << "1Generating new solution inside Solution::Solution(solution *solution)" << endl;
  variable_ = type_->copyVariables(solution->variable_) ;
 // cout << "2Generating new solution inside Solution::Solution(solution *solution)" << endl;
  overallConstraintViolation_ = solution->getOverallConstraintViolation();
//  cout << "3Generating new solution inside Solution::Solution(solution *solution)" << endl;
  numberOfViolatedConstraints_ = solution->getNumberOfViolatedConstraints();
 // cout << "4Generating new solution inside Solution::Solution(solution *solution)" << endl;
  distanceToSolutionSet_ = solution->getDistanceToSolutionSet();
 // cout << "5Generating new solution inside Solution::Solution(solution *solution)" << endl;
  crowdingDistance_ = solution->getCrowdingDistance();
 // cout << "6Generating new solution inside Solution::Solution(solution *solution)" << endl;
  kDistance_ = solution->getKDistance();
//  cout << "7Generating new solution inside Solution::Solution(solution *solution)" << endl;
  fitness_ = solution->getFitness();
//  cout << "8Generating new solution inside Solution::Solution(solution *solution)" << endl;
  marked_ = solution->isMarked();
//  cout << "9Generating new solution inside Solution::Solution(solution *solution)" << endl;
  rank_ = solution->getRank();
 // cout << "10Generating new solution inside Solution::Solution(solution *solution)" << endl;
