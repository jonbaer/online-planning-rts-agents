...
Variable ** SolutionType::copyVariables(Variable **vars) {
 //cout <<"1Copying variables SolutionType::copyVariables" << endl;
  int numberOfVar = problem_->getNumberOfVariables();
  int var;
 // cout <<"2Copying variables SolutionType::copyVariables" << endl;
 ...
 // cout <<"3Copying variables SolutionType::copyVariables"<< numberOfVar << endl;
  for (var = 0; var < numberOfVar; var++) {
 // cout <<"4Copying variables SolutionType::copyVariables" << var << endl;
  
    variables[var] = vars[var]->deepCopy();
	
  }
 
 //cout <<"5Copying variables SolutionType::copyVariables" << endl;
  return variables;
} // copyVariables
