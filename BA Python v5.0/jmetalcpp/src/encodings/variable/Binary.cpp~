...
//cout <<"returning this Binary::deepCopy" << endl;
 ...
 */
// int Binary::getLowerBound(int index) {
   // cout << "ERROR: Binary::getLowerBound() Not Defined" << endl;
// } // getLowerBound
...
// /**
 ...
 // */
// int Binary::getUpperBound(int index) {
   // cout << "ERROR: Binary::getUpperBound() Not Defined" << endl;
// } // getLowerBound
