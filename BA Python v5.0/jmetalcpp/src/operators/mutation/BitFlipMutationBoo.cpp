 ...
 */
BitFlipMutationBoo::BitFlipMutationBoo(map<string, void *> parameters)
: Mutation(parameters) {
 ...
 * Destructor
 */
BitFlipMutationBoo::~BitFlipMutationBoo() { } // ~BitFlipMutationBoo
 ...
 */
void * BitFlipMutationBoo::doMutation(double probability, Solution *solution) {
  int numberOfVariables = solution->getNumberOfVariables() ;

  	// //Jay added this code
			for (int i = 0 ; i < numberOfVariables ; i++) {
				Binary * variable = (Binary *)(solution->getDecisionVariables()[1]) ;
 ...
 * @throws JMException
 */
void * BitFlipMutationBoo::execute(void *object) {
