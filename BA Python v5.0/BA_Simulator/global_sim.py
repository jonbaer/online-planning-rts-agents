...
#tracks actions that hold workers or a unary resource forever in order to collect gold, wood, minerals, etc (In BA commands that force construction vehicles to assist the commander)
gathering_actions = {}
...
effect_accum_metal = "Accumulate_Metal"  #Strictly on volumetric resources
effect_accum_NRG = "Accumulate_NRG" #Strictly for volumetric resources that are not rates, not held and are fixed (i.e supply in starcraft)
effect_nop = "NOP"				  #Reserved for null actions
effect_IncrementUnit = "Increment_Unit"
effect_CmdWorkTime = "Increment_CmdWorkTime"	#Reserved for Balanced Annihilation
effect_LabWorkTime = "Increment_FacWorkTime"
effect_MetalCapacity= "Inc_Metal_Cap"
effect_NRGCapacity="Inc_NRG_Cap"
